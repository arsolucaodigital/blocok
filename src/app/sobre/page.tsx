      ...
      <section className="container mx-auto my-12 px-4">
        <div className="w-full flex flex-col gap-4">
          ...
          <p className="text-md lg:text-lg font-semibold text-justify leading-normal w-full">
            O BLOCOK ORIGINAL é um sistema construtivo revolucionário de paredes
            prontas. É composto por duas placas cimentícias de microconcreto de
            15mm cada e uma placa de EPS industrial do tipo F com tecnologia
            antichama, com tamanho padrão de 90x90cm e variações em sua
            espessura, que são: 10cm, 13cm, 15cm e 20cm. O BLOCOK possui alta
            resistência de 12MPa e também proporciona maior conforto por ser
            termoacústico. Estrutura do Blocok Original
          </p>
