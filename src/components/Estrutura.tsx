...
export function Estrutura({textPlacaConcreto, TextPlacaEPS, image }: EstruturaProps) {
  return (
    <section className="bg-gray-100 mt-8 lg:mt-12 w-full  py-32">
      <div className="flex container px-4 mx-auto flex-col">
        <h2 className="text-5xl lg:text-8xl font-bold uppercase font-bebas tracking-wide w-full text-center mb-14">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-4 items-center">
          <div className="w-full lg:w-1/2 flex flex-col gap-4">
            <div className="flex flex-col gap-4 mb-10">
              ...
              <p className="text-lg lg:text-xl font-bold text-justify">
              {textPlacaConcreto}
              </p>
            </div>
            ...
            <div className="border-solid border-4 border-black  mx-auto w-full lg:w-[80%] my-8 ">
              <div className="flex flex-col gap-4 bg-blue-100 items-center py-10  justify-center border-solid border-4 border-white">
                ...
                <p className="text-lg lg:text-xl font-bold text-center px-8 uppercase">
                  O blocok não tem malha de aço em sua estrutura
                </p>
              </div>
            </div>
            <div className="w-[60%] h-[100px] mx-auto mb-6 bg-gray-500"></div>
