      ...
      <div className="container mx-auto px-4 lg:px-12 py-12 flex-col flex lg:flex-row gap-16 items-center">
        <div className="w-full flex lg:w-1/2 gap-6">
          <div className="w-full">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                <label htmlFor="nome" className="text-sm text-black font-bold">
                  Nome*
                </label>
                <input
                  {...register('nome')}
                ...
                />
                {errors.nome && (
                  <p className="text-red-600 text-xs font-bold">{errors.nome.message}</p>
                )}
              </div>
              <div className="flex gap-4 w-full">
                <div className="w-full">
                  ...
                  />
                  {errors.celular && (
                    <p className="text-red-600 text-xs font-bold">{errors.celular.message}</p>
                  )}
                </div>
                <div className="w-full">
                  <label
              ...
              <div className="flex gap-4 w-full">
                <div className="w-full">
                  <label htmlFor="cep" className="text-sm text-black font-bold">
                    CEP*
                  </label>
                  <input
                    {...register('cep')}
                  ...
                  {errors.cep && (
                    <p className="text-red-600 text-xs font-bold">{errors.cep.message}</p>
                  )}
                </div>
                <div className="w-full">
                  <label
                  ...
                  />
                  {errors.cidade && (
                    <p className="text-red-600 text-xs font-bold">{errors.cidade.message}</p>
                  )}
                </div>
              </div>
              <div className="flex gap-4 w-full">
                <div className="w-full">
                  ...
                  />
                  {errors.bairro && (
                    <p className="text-red-600 text-xs font-bold">{errors.bairro.message}</p>
                  )}
                </div>
                <div className="w-full">
                  <label
                  ...
                  />
                  {errors.estado && (
                    <p className="text-red-600 text-xs font-bold">{errors.estado.message}</p>
                  )}
                </div>
              </div>
              <div>
                ...
                />
                {errors.mensagem && (
                  <p className="text-red-600 text-xs font-bold">{errors.mensagem.message}</p>
                )}
              </div>
              <button
                type="submit"
                className="bg-blue-200 text-white p-2 rounded w-[300px] hover:bg-blue-400 flex justify-center items-center text-center cursor-pointer"
              >
                Enviar
              </button>
            </form>
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
          <h2 className="text-5xl lg:text-8xl font-bold mb-4 uppercase font-bebas tracking-wide">
            Seja Um Franqueado
            <span className="text-blue-200 w-full block">blocok original</span>
          </h2>
